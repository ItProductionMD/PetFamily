...
public class HardDeletePetHandler(
    ...
    ILogger<SoftDeletePetHandler> logger) : ICommandHandler<HardDeletePetCommand>
{
    ...
    public async Task<UnitResult> Handle(HardDeletePetCommand cmd, CancellationToken cancelToken)
    {
