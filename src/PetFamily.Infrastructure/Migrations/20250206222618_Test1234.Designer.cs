...
namespace PetFamily.Infrastructure.Migrations
{
    ...
    [Migration("20250206222618_Test1234")]
            ...
            modelBuilder.Entity("PetFamily.Domain.PetAggregates.Root.Pet", b =>
                {
                    ...
                    b.OwnsOne("ValueObjectList", "DonateDetails", b1 =>
                        {
                    ...
                    b.OwnsOne("PetFamily.Domain.Shared.ValueObjects.ValueObjectList<PetFamily.Domain.Shared.ValueObjects.DonateDetails>", "DonateDetailsList", b1 =>
                        {
                            ...
                            b1.OwnsMany("PetFamily.Domain.Shared.ValueObjects.DonateDetails", "ObjectList", b2 =>
                                {
                                    b2.Property<Guid>("ValueObjectList<DonateDetails>VolunteerId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("ValueObjectList<DonateDetails>VolunteerId", "__synthesizedOrdinal");
                                    ...
                                    b2.WithOwner()
                                        .HasForeignKey("ValueObjectList<DonateDetails>VolunteerId")
                                        .HasConstraintName("fk_volunteers_volunteers_value_object_list_donate_details_volunte");
                                });
