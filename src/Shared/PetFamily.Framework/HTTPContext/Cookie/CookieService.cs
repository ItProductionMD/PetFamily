...
public class CookieService(
    ...
    IOptions<RefreshTokenCookieOptions> options) : ICookieService
{
    private readonly RefreshTokenCookieOptions _options = options.Value;
    ...
    public void SetRefreshToken(AuthorizationTokens tokenResult)
    {
