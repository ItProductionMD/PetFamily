...
public class PetTests
{
    ...
    [Fact]
    public void Should_Change_MainPetImage()
    {
        //ARRANGE
        var volunteer = TestDataFactory.CreateVolunteer(1);
        var pet = volunteer.Pets[0];
        ...
        //ACT
        pet.ChangeMainPhoto(imageName2);

        //ASSERT
        Assert.Equal(imageName2, pet.Images[0].Name);
        Assert.Equal(imageName1, pet.Images[1].Name);
    }
}
